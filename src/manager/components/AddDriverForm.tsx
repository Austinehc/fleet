...
export default function AddDriverForm({
  ...
  return (
    <div className="fixed inset-0 z-55 bg-gray-950/70 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto" id="add-driver-modal">
      <div className="bg-white rounded-2xl max-w-2xl w-full border border-gray-100 overflow-hidden shadow-2xl flex flex-col max-h-[90vh] my-4" id="add-driver-modal-box">
